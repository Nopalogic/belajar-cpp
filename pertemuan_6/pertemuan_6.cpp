...
int main(){
	...
	string arrNamaProdi[jumlahProdi], avgTitle="average";
	int i, j, total, indexPosition;
	
	string header[2+jumlahProdi]={"TA"};
	string averageTitle[1] = {"Rata-rata kelulusan per tahun"};
...
//	----------------------------------------
	...
	for(i = 0; i < jumlahTA; i++){
		arrDataKelulusan[i][indexPosition-1] = averageProdi[i];
		indexPosition++;
	}
